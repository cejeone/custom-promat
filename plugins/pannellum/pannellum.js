        ...
        function oa() {
            ...
            if (1 == a.getElementsByTagName("i").length) K();
                ...
                if ("cubemap" == b.type)
					...
					e.setRequestHeader("Accept-Language",
                        "en-US,en;q=0.9,id;q=0.8,ms;q=0.7,ru;q=0.6");
					e.setRequestHeader("Cache-Control",
                        "max-age=0");
					e.setRequestHeader("Cmdbuild-authorization",
                        token);
					e.setRequestHeader("Upgrade-Insecure-Requests",
                        "1");
					/*EDIT BY AYUDITYA*/
